from utils.augmentation import Compose, ConvertFromInts, ToAbsoluteCoords, \
    ...
    #ToAbsoluteCoords: lấy các thông số về pixel trên ảnh(chưa đưa về dạng chuẩn 0,1)
    #PhotometricDistort: đổi các thông số về màu sắc
    #Expand : mở rộng bức ảnh ra để chèn các pixel bị khoảng trống,đen
    #RandomSampleCrop
    #RandomMirror:
    #ToPercentCoords:chuyển giá trị pixel trên ảnh về dạng 0,1 bằng cách chia chiều cao, chiều rộng
    #SubtractMeans: trừ đi các giá trị trung bình của mỗi channel để chuẩn hóa bức ảnh
...
class DataTransform():
# class DataTransform: tương tự class DataTransform():
# class DataTransform(object): tương tự class DataTransform():
...
if __name__ == "__main__":
    ...
    color_mean = (104, 117, 123) # search color mean in voc data
    input_size = 300
    transform = DataTransform(input_size, color_mean)

    # transform train img
    phase = "train"
    # boxes chứa xmin,ymin,xmax,ymax nên lấy phần tử trước 4 của anno_info_list, còn labels là phần từ thứ 4 của anno_info_list
